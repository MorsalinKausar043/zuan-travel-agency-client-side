...
const Footer = () => {
    return (
        <>
            <footer className="text-center px:2 md:px-20 lg:text-left bg-gray-100 text-gray-600">
                ...
                <div className="text-center p-6 bg-gray-200">
                    ...
                    <a className="text-gray-600 font-semibold" href="https://tailwind-elements.com/">Morsalin Kausar</a>
                </div>
            </footer>
        </>
    );
